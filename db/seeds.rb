...
RelationshipType.create(:name => "Daughter")
RelationshipType.create(:name => "Son")
RelationshipType.create(:name => "Sister")
RelationshipType.create(:name => "Brother")
RelationshipType.create(:name => "Grandmother")
RelationshipType.create(:name => "Grandfather")
RelationshipType.create(:name => "Aunt")
