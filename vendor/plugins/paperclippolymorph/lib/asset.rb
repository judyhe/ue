class Asset < ActiveRecord::Base
  ...
  has_attached_file :data, :url => "/system/:class/:id/:basename_:style.:extension", :default_url => "/system/:class/:attachment_missing_:style.png", :styles => { :thumb => "32x32>", :medium => "100x100>"}
